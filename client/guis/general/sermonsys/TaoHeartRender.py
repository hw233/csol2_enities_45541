...
class TaoHeartRender( AdjModelRender ) :
	__cc_config = "config/client/uimodel_configs/taoheart.py"

	def __init__( self, mirror ) :
		AdjModelRender.__init__( self, mirror, -1, self.__cc_config )
		self.bgTexture = "guis/general/sermonsys/taoheartwnd/circlebg.dds"		# 背景贴图
		self.mapping = util.getGuiMapping( ( 256, 256 ), 24, 235, 23, 235 )
