...
class CampFengHuoIntegrationBox( QuestBox ) :
	"""
	"""
	...
	def onItemsArrived( self, caster, itemList ):
		...
		if caster.isEntityType( csdefine.ENTITY_TYPE_ROLE ):
			self.getCurrentSpaceBase().cell.addCampFengHuoLianTianIntegral( caster.getCamp(), INTEGRAL )
			self.addTimer( 0.5, 0, ECBExtend.DESTROY_SELF_TIMER_CBID )


	
# CampFengHuoIntegrationBox.py
