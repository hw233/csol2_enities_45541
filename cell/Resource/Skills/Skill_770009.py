...
class Skill_770009( Skill_Normal ):
	"""
	骑宠技能 沉默抵抗,例如:主人及主人的出战宠物，抵抗沉默的几率提高1%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "resist_chenmo_probability_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcResistChenmoProbability" )
