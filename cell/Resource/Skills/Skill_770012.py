...
class Skill_770012( Skill_Normal ):
	"""
	骑宠技能 物理伤害强化,例如:主人及主人的出战宠物，所造成的物理伤害提高1%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "damage_min_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "" )
		ownerEntity.affectPropValue( "damage_max_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcDynamicProperties" )
