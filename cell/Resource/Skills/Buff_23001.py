# -*- coding: gb18030 -*-
#
# $Id: Buff_23001.py,v 1.2 2008-02-28 08:25:56 kebiao Exp $
...
class Buff_23001( Buff_Shield ):
	"""
	example:将受到的物理伤害，按x%的比率，扣除法力值，最多转化y点伤害，转化完后，护盾消失
	"""
	def __init__( self ):
		"""
		构造函数。
	...
	def doShield( self, receiver, damageType, damage ):
		...
		@rtype: 返回被消减后的伤害值
		"""
		if damageType != csdefine.DAMAGE_TYPE_PHYSICS:
			return damage
