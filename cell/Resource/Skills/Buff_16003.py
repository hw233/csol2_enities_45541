# -*- coding: gb18030 -*-
#
# $Id: Buff_16003.py,v 1.12 2008-08-11 07:55:59 kebiao Exp $
...
class Buff_16003( Buff_Rebound ):
	"""
	example:效果存在时将所受到的物理攻击力（含技能）转移一定数值到攻击者身上。（被转移单位不能为自身）
	"""
	def __init__( self ):
		"""
		构造函数。
	...
	def springOnDamage( self, caster, receiver, skill, damage ):
		...
		SkillMessage.buff_ReboundDamagePhy( caster, receiver, value )
