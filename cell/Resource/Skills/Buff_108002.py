# -*- coding: gb18030 -*-
#
# $Id: Buff_108002.py,v 1.13 2008-07-04 03:50:57 kebiao Exp $
...
class Buff_108002( Buff_Normal ):
	...
	def doBegin( self, receiver, buffData ):
		...
		if receiver.attrIntonateTimer > 0 and receiver.attrIntonateSkill.getType() in Const.INTERRUPTED_BASE_TYPE or\
			...
			receiver.interruptSpell( csstatus.SKILL_IN_SLEEP )
		receiver.effectStateInc( csdefine.EFFECT_STATE_SLEEP )
		# 执行附加效果
	...
	def doEnd( self, receiver, buffData ):
		...
		receiver.effectStateDec( csdefine.EFFECT_STATE_SLEEP )
		receiver.actCounterDec( STATES )
		
#
# $Log: not supported by cvs2svn $
# Revision 1.12  2008/07/04 01:03:58  kebiao
# 增加了禁止跳跃状态
#
# Revision 1.11  2008/07/03 02:49:39  kebiao
# 改变 睡眠 定身等效果的实现
#
# Revision 1.10  2007/12/25 03:09:16  kebiao
# 调整效果记录属性为effectLog
#
# Revision 1.9  2007/12/22 03:27:26  kebiao
# 修正添加BUFF错误
#
# Revision 1.8  2007/12/22 02:26:57  kebiao
# 调整免疫相关接口
#
# Revision 1.7  2007/12/13 00:48:08  kebiao
# 重新修正了状态改变部分，因为底层有相关冲突机制 因此这里就不再关心冲突问题
#
# Revision 1.6  2007/12/12 06:42:50  kebiao
# 调整判断方式
#
# Revision 1.5  2007/12/12 06:25:31  kebiao
# add:import random
#
