# -*- coding: gb18030 -*-
#
# $Id: Buff_16009.py,v 1.15 2008-08-11 07:55:59 kebiao Exp $
...
class Buff_16009( Buff_Rebound_Magic ):
	"""
	example:当角色受到物理攻击时，反射一定数值的法术伤害给攻击者
	...
	def springOnDamage( self, caster, receiver, skill, damage ):
		...
		@type    damage: int32
		"""
		if caster.id == receiver.id or receiver.state == csdefine.ENTITY_STATE_DEAD or skill.getType() not in csconst.BASE_SKILL_INITIA_SPELL_LIST:
			return
		
		value = int( self.initMagicDotDamage( receiver, caster, self._p1 ) ) 
...
# Revision 1.14  2008/04/10 04:08:26  kebiao
# 改为在接受伤害之前通知客户端接受技能处理
#
# Revision 1.13  2008/04/10 03:25:50  kebiao
# modify to receiveSpell pertinent.
#
# Revision 1.12  2008/03/31 09:04:02  kebiao
# 修改receiveDamage和通知客户端接受某技能结果分开
# 技能通过receiveSpell通知客户端去表现，支持各技能不同的表现
#
# Revision 1.11  2008/02/25 09:28:46  kebiao
# 修改伤害反弹部分
#
# Revision 1.10  2008/02/13 09:26:30  kebiao
# 将技能ID也传输到客护短,使其显示伤害
#
# Revision 1.9  2008/02/13 08:54:58  kebiao
# 修正反弹伤害没有施法者ID
#
# Revision 1.8  2008/02/13 08:41:30  kebiao
# 添加相关提示信息
#
# Revision 1.7  2008/01/30 08:59:37  kebiao
# 修改反弹信息处理方式
#
# Revision 1.6  2008/01/30 07:07:46  kebiao
# 修改了继承关系
#
# Revision 1.5  2007/12/21 08:52:11  kebiao
# no message
#
# Revision 1.4  2007/12/21 07:28:00  kebiao
# no message
#
# Revision 1.3  2007/12/21 04:21:10  kebiao
# 修正一些BUG
#
# Revision 1.2  2007/12/21 03:07:42  kebiao
# no message
#
