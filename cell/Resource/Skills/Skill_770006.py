...
class Skill_770006( Skill_Normal ):
	"""
	骑宠技能 物防强化:主人及主人的出战宠物，物理防御值提高1%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "armor_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcArmor" )
