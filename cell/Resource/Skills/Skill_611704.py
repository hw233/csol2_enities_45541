...
class Skill_611704( Skill_Normal ):
	"""
	按比例增加主人和宠物的体质。
	"""
	def __init__( self ):
	...
	def init( self, dict ):
		...
		self._param1 = int( dict[ "param1" ] if len( dict[ "param1" ] ) > 0 else 0 )  * 100.0
		self._param2 = int( dict[ "param2" ] if len( dict[ "param2" ] ) > 0 else 0 )  * 100.0
