...
class Skill_770011( Skill_Normal ):
	"""
	骑宠技能 定身抵抗,例如:主人及主人的出战宠物，抵抗定身的几率提高1%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "resist_fix_probability_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcResistFixProbability" )
