# -*- coding: gb18030 -*-
#
# $Id: Buff_107006.py,v 1.7 2008-08-11 07:55:59 kebiao Exp $
...
class Buff_107006( Buff_Normal ):
	"""
	example:失去生命值%	DEBUFF	无属性损失生命	按一定数值缓慢失去生命。
	"""
	def __init__( self ):
		"""
		构造函数。
	...
	def doLoop( self, receiver, buffData ):
		...
		@rtype:  BOOL
		"""
		damage = self.calcDotDamage( receiver, receiver, csdefine.DAMAGE_TYPE_VOID, int( receiver.HP_Max * self._p1 ) )
