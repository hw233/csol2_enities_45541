...
class Skill_770010( Skill_Normal ):
	"""
	骑宠技能 昏睡抵抗,例如:主人及主人的出战宠物，抵抗昏睡的几率提高1%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "resist_sleep_probability_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcResistSleepProbability" )
