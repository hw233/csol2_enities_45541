# -*- coding: gb18030 -*-
#
# $Id: Buff_15001.py,v 1.1 2008-08-30 10:01:12 wangshufeng Exp $
...
class Buff_15001( Buff_Shield ):
	"""
	盾·消金，给自身施放一个防御护盾，吸收物理伤害
	"""
	def __init__( self ):
		"""
		"""
	...
	def doShield( self, receiver, damageType, damage ):
		...
		if not damageType & ( csdefine.DAMAGE_TYPE_PHYSICS_NORMAL | csdefine.DAMAGE_TYPE_PHYSICS ):
			return damage
