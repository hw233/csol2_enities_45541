...
class Skill_770003( Skill_Normal ):
	"""
	骑宠技能 蛮力:主人及主人的出战宠物，获得5%的基础力量加成。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "strength_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcDynamicProperties" )
