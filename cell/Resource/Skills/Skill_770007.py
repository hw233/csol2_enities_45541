...
class Skill_770007( Skill_Normal ):
	"""
	骑宠技能 法防强化:主人及主人的出战宠物，法术防御值提高1%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "magic_armor_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcMagicArmor" )
