# -*- coding: gb18030 -*-
#
# $Id: Buff_16002.py,v 1.12 2008-08-11 07:55:59 kebiao Exp $
...
class Buff_16002( Buff_Rebound_Magic ):
	"""
	example:法术反射	受到的法术攻击，按%i%%的几率反射给施放者。
	...
	def springOnDamage( self, caster, receiver, skill, damage ):
		...
		value = int( self.initMagicDotDamage( receiver, caster, damage * self._p1 ) )
