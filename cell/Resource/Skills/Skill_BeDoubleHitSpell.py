...
class Skill_BeDoubleHitSpell( Skill_Normal ):
	"""
	玩家被暴击命中后有几率对自身/目标放技能
	例如，对目标反击造成伤害
	"""
	def __init__( self ):
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.appendVictimDoubleHit( self.getNewObj() )
	...
	def detach( self, ownerEntity ):
		...
		@type ownerEntity:	BigWorld.Entity
		"""
		ownerEntity.removeVictimDoubleHit( self.getUID() )
