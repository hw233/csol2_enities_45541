...
class Skill_770004( Skill_Normal ):
	"""
	骑宠技能 迅捷:主人及主人的出战宠物，获得x%的基础敏捷加成。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "dexterity_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcDynamicProperties" )
