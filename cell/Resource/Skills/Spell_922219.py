			...
			if sk.getPercent() == selfBuff.getPercent():
				...
				if sk.isCharge != selfBuff.isCharge:
					if selfBuff.isCharge:
						...
						caster.statusMessage( csstatus.TAKE_EXP_BUFF_EXIST1, sexp )
