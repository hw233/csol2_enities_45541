...
class Skill_770005( Skill_Normal ):
	"""
	骑宠技能 招架强化:主人及主人的出战宠物，招架提高x%。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "resist_hit_probability_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcResistHitProbability" )
