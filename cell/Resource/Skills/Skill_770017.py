...
class Skill_770017( Skill_Normal ):
	"""
	骑宠技能 聪慧:主人及主人的出战宠物，获得5%的基础智力加成。
	"""
	def __init__( self ):
		"""
		"""
	...
	def attach( self, ownerEntity ):
		...
		"""
		ownerEntity.affectPropValue( "intellect_percent", self.param * ownerEntity.queryTemp( "vehicleJoyancyEffect", 0.0 ), "calcDynamicProperties" )
