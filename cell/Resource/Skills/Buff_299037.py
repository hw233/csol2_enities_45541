...
class Buff_299037( Buff_Normal ):
	...
	def doBegin( self, receiver, buffData ):
		...
		if receiver.queryTemp( "buff_299037_begin", False ):
			return
		receiver.setTemp( "buff_299037_begin", True )
		receiver.actCounterInc( csdefine.ACTION_FORBID_MOVE | csdefine.ACTION_FORBID_JUMP )
		...
		receiver.actCounterDec( csdefine.ACTION_FORBID_MOVE | csdefine.ACTION_FORBID_JUMP )
	...
	def doLoop( self, receiver, buffData ):
		...
		@rtype:  BOOL
		"""
		if receiver.queryTemp( "buff_299037_exit", False ) :
			return False
	...
	def doReload( self, receiver, buffData ):
		...
		receiver.setTemp( "FLY_TEL_SKILL_FLAG", self.flag )
		receiver.setTemp( "NOT_USE_SELF_SKILL_FLAG", self.notUseSelfSkill )
		receiver.setTemp( "buff_299037_exit", True )
		receiver.appendImmunityBuff( buffData[ "skill" ] ) #首先添加抵抗
		if receiver.getCurrentSpaceData( csconst.SPACE_SPACEDATA_KEY ) == self.spaceName :
	...
	def doEnd( self, receiver, buffData ):
		...
		# 暂时不实现上线后继续巡逻
		if receiver.popTemp( "buff_299037_exit", False ) :
			return
		...
		receiver.removeTemp( "buff_299037_begin" )
	...
	def addToDict( self ):
		...
		"""
		return { "param" : { "spaceName" 		: self.spaceName, 
					"pos" 			: self.pos, 
