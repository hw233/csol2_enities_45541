...
class FuncTongCampaignRaid( Function ):
	"""
	申请魔物来袭活动
	"""
	def __init__( self, section ):
		...
		"""
		#self.param1 = [ int(e) for e in section['param1'].asString.split( "," ) ]
	...
	def do( self, player, talkEntity = None ):
		...
		@return: None
		"""
		#player.client.tong_openReuqestCampaignMonsterRaidWindow( talkEntity.id, self.param1 )
		tongMailbox = player.tong_getSelfTongEntity()
		if tongMailbox:
			tongMailbox.startCampaign_monsterRaid( player.databaseID, self.param1 )
