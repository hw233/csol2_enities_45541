...
class FuncQueryCityContestTong( Function ):
	"""
	查询帮会竞争该城市的帮会
	"""
	...
	def do( self, player, talkEntity = None ):
		...
		"""
		pass
		#player.getTongManager().onQueryCityContestTong( player.getCurrentSpaceData( csconst.SPACE_SPACEDATA_KEY ), player.base, player.tong_dbID, talkEntity.id )
