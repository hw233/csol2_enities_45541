...
class FuncTongCityWarBuyXJ( Function ):
	"""
	帮会城市战 购买 玄坚
	"""
	...
	def do( self, player, talkEntity = None ):
		...
		if tongMailbox:
			tongMailbox.onCityWarBuyMachine( player.databaseID, csdefine.TONG_CW_FLAG_XJ, player.getCurrentSpaceBase(), talkEntity.position )		
