...
class SpaceDomainTongTurnWar( SpaceDomain ):
	"""
	帮会车轮战space管理
	"""
	def __init__( self ):
	...
	def teleportEntity( self, position, direction, baseMailbox, params ):
		...
		@type params : PY_DICT
		"""
		BigWorld.globalData[ "TongManager" ].onEnterTongTurnWarSpace( self, position, direction, baseMailbox, params )
		
	def onEnterTongTurnWarSpace( self, playerBase, direction, enterKeyDict ):
		"""
		Define method.
		玩家登录空间
		"""
	...
	def getSpaceItemByTeamID( self, teamID ):
		number = self._teamID2Number.get( teamID )
	...
	def createSpaceItem( self, params ):
		...
		self._teamID2Number[ teamID1 ] = spaceItem.spaceNumber
		self._teamID2Number[ teamID2 ] = spaceItem.spaceNumber
		return spaceItem
	...
	def teleportEntityOnLogin( self, baseMailbox, params ):
		...
		"""
		params["login"] = True
		BigWorld.globalData[ "TongManager" ].onEnterTongTurnWarSpace( self, ( 0, 0, 0 ), ( 0, 0, 0 ), baseMailbox, params )
